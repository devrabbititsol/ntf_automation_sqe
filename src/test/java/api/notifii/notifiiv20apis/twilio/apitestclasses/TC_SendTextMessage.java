package api.notifii.notifiiv20apis.twilio.apitestclasses;
...
import api.notifii.notifiiv20apis.twilio.apipageclasses.SendTextMessageDataset;
public class TC_SendTextMessage extends BaseClass {

	private Logger logger;
	private ConfigFilesUtility configFileObj;

	public TC_SendTextMessage() throws Exception {
		PropertyConfigurator.configure("log4j.properties");
		logger = Logger.getLogger(TC_SendTextMessage.class);
		configFileObj= new ConfigFilesUtility();
		configFileObj.loadPropertyFile("TC_SendTextMessage.properties");
	}
	...
	public void doRequest() throws Exception { 
		...
		/*--------------------- POST --------------------- */
			...
			if(isExecutionFlag) {
 			 	Object object = (Object) new SendTextMessageDataset();
