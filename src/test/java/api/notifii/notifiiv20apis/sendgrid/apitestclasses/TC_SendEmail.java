package api.notifii.notifiiv20apis.sendgrid.apitestclasses;
...
import api.notifii.notifiiv20apis.sendgrid.apipageclasses.SendGridEmailDataset;
public class TC_SendEmail extends BaseClass {

	private Logger logger;
	private ConfigFilesUtility configFileObj;

	public TC_SendEmail() throws Exception {
		PropertyConfigurator.configure("log4j.properties");
		logger = Logger.getLogger(TC_SendEmail.class);
		configFileObj= new ConfigFilesUtility();
		configFileObj.loadPropertyFile("TC_SendEmail.properties");
	}
	...
	public void doRequest() throws Exception { 
		...
		/*--------------------- POST --------------------- */
			...
			if(isExecutionFlag) {
 			 	Object object = (Object) new SendGridEmailDataset();
