...
public class GetTemplateByAccountIDAndTemplateIDDataset{
...
public static final String datasetHeader1 = "TC_GetTemplatesByAccountID&TemplateID-Dataset# Valid Details";

public static final String datasetResources1 = "track/getTemplateByAccountIdAndTemplateId";
public static final int requestType1 = 1;
public static final int bodyType1 = 3;
public static final String apiName1 = "Get Template By Account ID and Template ID";

 public static String urlParams1  = "[]";

 public static String headers1  = "[{\"header_id\":1426,"
