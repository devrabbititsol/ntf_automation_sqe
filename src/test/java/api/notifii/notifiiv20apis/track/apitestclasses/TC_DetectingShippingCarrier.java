...
import api.notifii.notifiiv20apis.track.apipageclasses.DetectShippingCarrierDataset;
public class TC_DetectingShippingCarrier extends BaseClass {

	private Logger logger;
	private ConfigFilesUtility configFileObj;

	public TC_DetectingShippingCarrier() throws Exception {
		PropertyConfigurator.configure("log4j.properties");
		logger = Logger.getLogger(TC_DetectingShippingCarrier.class);
		configFileObj= new ConfigFilesUtility();
		configFileObj.loadPropertyFile("TC_DetectingShippingCarrier.properties");
	}
	...
	public void doRequest() throws Exception { 
		...
		/*--------------------- POST --------------------- */
			...
			if(isExecutionFlag) {
 			 	Object object = (Object) new DetectShippingCarrierDataset();
