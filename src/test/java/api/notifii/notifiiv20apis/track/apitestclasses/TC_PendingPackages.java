...
import api.notifii.notifiiv20apis.track.apipageclasses.PendingPackagesDataset;
public class TC_PendingPackages extends BaseClass {

	private Logger logger;
	private ConfigFilesUtility configFileObj;

	public TC_PendingPackages() throws Exception {
		PropertyConfigurator.configure("log4j.properties");
		logger = Logger.getLogger(TC_PendingPackages.class);
		configFileObj= new ConfigFilesUtility();
		configFileObj.loadPropertyFile("TC_PendingPackages.properties");
	}
	...
	public void doRequest() throws Exception { 
		...
		/*--------------------- POST --------------------- */
			...
			if(isExecutionFlag) {
 			 	Object object = (Object) new PendingPackagesDataset();
