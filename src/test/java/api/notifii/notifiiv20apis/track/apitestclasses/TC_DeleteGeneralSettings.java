...
import api.notifii.notifiiv20apis.track.apipageclasses.TrackDeleteSettingsDataset;
public class TC_DeleteGeneralSettings extends BaseClass {

	private Logger logger;
	private ConfigFilesUtility configFileObj;

	public TC_DeleteGeneralSettings() throws Exception {
		PropertyConfigurator.configure("log4j.properties");
		logger = Logger.getLogger(TC_DeleteGeneralSettings.class);
		configFileObj= new ConfigFilesUtility();
		configFileObj.loadPropertyFile("TC_DeleteGeneralSettings.properties");
	}
	...
	public void doRequest() throws Exception { 
		...
		/*--------------------- POST --------------------- */
			...
			if(isExecutionFlag) {
 			 	Object object = (Object) new TrackDeleteSettingsDataset();
