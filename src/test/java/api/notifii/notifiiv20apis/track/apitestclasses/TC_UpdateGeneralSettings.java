...
import api.notifii.notifiiv20apis.track.apipageclasses.TrackUpdateGeneralSettingsDataset;
public class TC_UpdateGeneralSettings extends BaseClass {

	private Logger logger;
	private ConfigFilesUtility configFileObj;

	public TC_UpdateGeneralSettings() throws Exception {
		PropertyConfigurator.configure("log4j.properties");
		logger = Logger.getLogger(TC_UpdateGeneralSettings.class);
		configFileObj= new ConfigFilesUtility();
		configFileObj.loadPropertyFile("TC_UpdateGeneralSettings.properties");
	}
	...
	public void doRequest() throws Exception { 
		...
		/*--------------------- POST --------------------- */
			...
			if(isExecutionFlag) {
 			 	Object object = (Object) new TrackUpdateGeneralSettingsDataset();
