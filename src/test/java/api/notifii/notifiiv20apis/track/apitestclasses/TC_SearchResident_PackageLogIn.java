...
import api.notifii.notifiiv20apis.track.apipageclasses.PackageLogInSearchRecipientDataset;
public class TC_SearchResident_PackageLogIn extends BaseClass {

	private Logger logger;
	private ConfigFilesUtility configFileObj;

	public TC_SearchResident_PackageLogIn() throws Exception {
		PropertyConfigurator.configure("log4j.properties");
		logger = Logger.getLogger(TC_SearchResident_PackageLogIn.class);
		configFileObj= new ConfigFilesUtility();
		configFileObj.loadPropertyFile("TC_SearchResident_Package LogIn .properties");
	}
	...
	public void doRequest() throws Exception { 
		...
		/*--------------------- POST --------------------- */
			...
			if(isExecutionFlag) {
 			 	Object object = (Object) new PackageLogInSearchRecipientDataset();
