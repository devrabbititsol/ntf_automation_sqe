package api.notifii.notifiiv20apis.track.apitestclasses;
...
import api.notifii.notifiiv20apis.track.apipageclasses.TrackNotificationTemplatesByAccountIDDataset;
public class TC_GetNotificationTemplatesByAccountID extends BaseClass {

	private Logger logger;
	private ConfigFilesUtility configFileObj;

	public TC_GetNotificationTemplatesByAccountID() throws Exception {
		PropertyConfigurator.configure("log4j.properties");
		logger = Logger.getLogger(TC_GetNotificationTemplatesByAccountID.class);
		configFileObj= new ConfigFilesUtility();
		configFileObj.loadPropertyFile("TC_GetNotificationTemplatesByAccountID.properties");
	}
	...
	public void doRequest() throws Exception { 
		...
		/*--------------------- GET --------------------- */
			...
			if(isExecutionFlag) {
 			 	Object object = (Object) new TrackNotificationTemplatesByAccountIDDataset();
