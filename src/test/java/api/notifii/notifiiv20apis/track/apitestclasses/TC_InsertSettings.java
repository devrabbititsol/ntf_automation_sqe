...
import api.notifii.notifiiv20apis.track.apipageclasses.TrackInsertSettingsDataset;
public class TC_InsertSettings extends BaseClass {

	private Logger logger;
	private ConfigFilesUtility configFileObj;

	public TC_InsertSettings() throws Exception {
		PropertyConfigurator.configure("log4j.properties");
		logger = Logger.getLogger(TC_InsertSettings.class);
		configFileObj= new ConfigFilesUtility();
		configFileObj.loadPropertyFile("TC_InsertSettings.properties");
	}
	...
	public void doRequest() throws Exception { 
		...
		/*--------------------- POST --------------------- */
			...
			if(isExecutionFlag) {
 			 	Object object = (Object) new TrackInsertSettingsDataset();
