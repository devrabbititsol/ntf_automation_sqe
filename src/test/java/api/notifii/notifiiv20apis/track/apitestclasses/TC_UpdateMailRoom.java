...
import api.notifii.notifiiv20apis.track.apipageclasses.UpdateMailRoomDataset;
public class TC_UpdateMailRoom extends BaseClass {

	private Logger logger;
	private ConfigFilesUtility configFileObj;

	public TC_UpdateMailRoom() throws Exception {
		PropertyConfigurator.configure("log4j.properties");
		logger = Logger.getLogger(TC_UpdateMailRoom.class);
		configFileObj= new ConfigFilesUtility();
		configFileObj.loadPropertyFile("TC_UpdateMailRoom.properties");
	}
	...
	public void doRequest() throws Exception { 
		...
		/*--------------------- POST --------------------- */
			...
			if(isExecutionFlag) {
 			 	Object object = (Object) new UpdateMailRoomDataset();
