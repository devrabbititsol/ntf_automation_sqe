...
import api.notifii.notifiiv20apis.track.apipageclasses.TrackingNumberUniquenessDataset;
public class TC_TrackingNumberUniqueness extends BaseClass {

	private Logger logger;
	private ConfigFilesUtility configFileObj;

	public TC_TrackingNumberUniqueness() throws Exception {
		PropertyConfigurator.configure("log4j.properties");
		logger = Logger.getLogger(TC_TrackingNumberUniqueness.class);
		configFileObj= new ConfigFilesUtility();
		configFileObj.loadPropertyFile("TC_TrackingNumberUniqueness.properties");
	}
	...
	public void doRequest() throws Exception { 
		...
		/*--------------------- POST --------------------- */
			...
			if(isExecutionFlag) {
 			 	Object object = (Object) new TrackingNumberUniquenessDataset();
