...
import api.notifii.notifiiv20apis.track.apipageclasses.GetTemplateByAccountIDAndTemplateIDDataset;
public class TC_GetTemplatesByAccountIDTemplateID extends BaseClass {

	private Logger logger;
	private ConfigFilesUtility configFileObj;

	public TC_GetTemplatesByAccountIDTemplateID() throws Exception {
		PropertyConfigurator.configure("log4j.properties");
		logger = Logger.getLogger(TC_GetTemplatesByAccountIDTemplateID.class);
		configFileObj= new ConfigFilesUtility();
		configFileObj.loadPropertyFile("TC_GetTemplatesByAccountID&TemplateID.properties");
	}
	...
	public void doRequest() throws Exception { 
		...
		/*--------------------- GET --------------------- */
			...
			if(isExecutionFlag) {
 			 	Object object = (Object) new GetTemplateByAccountIDAndTemplateIDDataset();
