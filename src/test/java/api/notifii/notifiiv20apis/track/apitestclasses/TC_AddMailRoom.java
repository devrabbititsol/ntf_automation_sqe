...
import api.notifii.notifiiv20apis.track.apipageclasses.TrackAddMailRoomDataset;
public class TC_AddMailRoom extends BaseClass {

	private Logger logger;
	private ConfigFilesUtility configFileObj;

	public TC_AddMailRoom() throws Exception {
		PropertyConfigurator.configure("log4j.properties");
		logger = Logger.getLogger(TC_AddMailRoom.class);
		configFileObj= new ConfigFilesUtility();
		configFileObj.loadPropertyFile("TC_AddMailRoom.properties");
	}
	...
	public void doRequest() throws Exception { 
		...
		/*--------------------- POST --------------------- */
			...
			if(isExecutionFlag) {
 			 	Object object = (Object) new TrackAddMailRoomDataset();
