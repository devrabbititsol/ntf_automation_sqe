...
import api.notifii.notifiiv20apis.track.apipageclasses.TrackGeneralSettingsDataset;
public class TC_GetGeneralSettingsAPI extends BaseClass {

	private Logger logger;
	private ConfigFilesUtility configFileObj;

	public TC_GetGeneralSettingsAPI() throws Exception {
		PropertyConfigurator.configure("log4j.properties");
		logger = Logger.getLogger(TC_GetGeneralSettingsAPI.class);
		configFileObj= new ConfigFilesUtility();
		configFileObj.loadPropertyFile("TC_GetGeneralSettingsAPI.properties");
	}
	...
	public void doRequest() throws Exception { 
		...
		/*--------------------- GET --------------------- */
			...
			if(isExecutionFlag) {
 			 	Object object = (Object) new TrackGeneralSettingsDataset();
