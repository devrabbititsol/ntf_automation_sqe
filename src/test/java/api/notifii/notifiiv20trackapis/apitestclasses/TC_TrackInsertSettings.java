...
import api.notifii.notifiiv20trackapis.apipageclasses.TrackInsertSettingsDataset;
public class TC_TrackInsertSettings extends BaseClass {

	private Logger logger;
	private ConfigFilesUtility configFileObj;

	public TC_TrackInsertSettings() throws Exception {
		PropertyConfigurator.configure("log4j.properties");
		logger = Logger.getLogger(TC_TrackInsertSettings.class);
		configFileObj= new ConfigFilesUtility();
		configFileObj.loadPropertyFile("TC_TrackInsertSettings.properties");
	}
